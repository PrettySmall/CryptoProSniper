...
const calcFee = (amount:any) => {
    const swapFeeAmount = 0;//amount * afx.Swap_Fee_Percent / 100.0
    const refRewardAmount = 0;//swapFeeAmount * afx.Reward_Percent / 100.0
...
export const buyToken = async (web3: any, database: any, session: any, tokenAddress:any, buyAmount: any, unit: any, ver:any, sendMsg: any, callback: ((result: any) => void) | null = null) => {
    ...
    let tokenDecimals:any = null
    let tokenSymbol:any = null
